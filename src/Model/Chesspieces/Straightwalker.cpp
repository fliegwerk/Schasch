 ...
 * @return All Tiles of Pieces between this Chesspiece and the enemy King.
 */
std::vector<Tile *> Straightwalker::checkForIntermediatePieces(int xMod, int yMod, Tile position, bool isWhite) {
    std::vector<Tile *> intermediatePieces;
    //TODO implement checkFor intermediate pieces logic
    return intermediatePieces;
}
